            ...
            <div className="nav_con">
              ...
              <div className={css.menu_con}>
                ...
                <div className={css.flex_row}>
                  ...
                  <svg viewBox="0 0 24 24" aria-hidden="true" width={25} height={25} focusable="false" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className="StyledIconBase-sc-ea9ulj-0 bhLQRR sc-dkrFOg jKpGpm">
